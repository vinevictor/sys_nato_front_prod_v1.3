...
export interface InputConstrutoraRazaoSocialProps extends InputProps {
  setValueRazaoSocial?: string;
}
export default function InputConstrutoraRazaoSocial({ setValueRazaoSocial, ...props }: InputConstrutoraRazaoSocialProps) {
